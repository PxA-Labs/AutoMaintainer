...
import { ChevronRight, ChevronDown, File as FileIcon, FolderOpen, Folder, Save, Search, X, Plus, Trash2, FilePlus, FolderPlus, Sparkles } from "lucide-react";
...
export default function WebIDE({ repoUrl }: WebIDEProps) {
  ...
  const handleAcceptInlineAssist = (replacementCode: string) => {
    ...
    setEditedContents((prev) => ({ ...prev, [activeTab]: updatedValue }));
